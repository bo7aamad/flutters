      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              "Zeus Workstation wasn't born on a trading floor, but in the demanding world of gas turbine engineering. In industrial engineering, precision is absolute and there is zero tolerance for error. The same rigor that protects lives now protects portfolios.",
            ...
            _buildBulletPoint("Multi-Timeframe Confluence & X-Ray", "We cross-reference daily and 4-hour structural trends, executing only when both lock into a 'Golden Confluence.' Our X-Ray UI reveals the reasoning behind every trade."),
            _buildBulletPoint("Fundamental Earnings Radar", "Technicals mean nothing during a fundamental gap. The engine continuously scans global corporate calendars, automatically blocking trades 5 days before earnings."),
            _buildBulletPoint("Institutional Volume Verification", "We pull real tick data to verify that every breakout is backed by actual market volume, automatically filtering out fake signal noise."),
            _buildBulletPoint("Volatility-Adjusted Sizing", "Using the Average True Range (ATR), the engine dynamically calculates precise stop-losses and position sizes to automatically protect downside."),
            _buildBulletPoint("Autonomous Watchdog Telemetry", "The workstation does not sleep. Our background auto-pilot scans the entire market grid every 60 minutes, calculating dynamic thresholds and pushing live alerts."),
